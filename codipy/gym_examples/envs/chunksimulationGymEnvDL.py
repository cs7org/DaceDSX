...
class chunksimulation_env(gym.Env):
    """
    ...
    def __init__(self):
        ...
        # Actions we can take:
        # initial seed number 0 - max_chunks
        self.action_size = 2
        self.action_space = spaces.Discrete(self.action_size)  # {0,1} seed or not
    ...
    def step(self, action: ActType) -> Tuple[ObsType, float, bool, bool, dict]:
        ...
        seeding_number = int(remained * self.seed_size)
        #print("seeding number in step-function:", seeding_number)
        self.state, done = self.seeding_step(action, seeding_number)
    ...
    def seeding_step(self, action: ActType, seeding_number:int ):
        """
        ...
        # action == 0: seed
            ...
            return ("Error! wrong action number")
