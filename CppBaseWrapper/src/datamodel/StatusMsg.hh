...
#ifndef CPP_STATUSMSG_HH_1303895446__H_
#define CPP_STATUSMSG_HH_1303895446__H_
...
namespace avro {
template<> struct codec_traits<daceDS::datamodel::StatusMsg> {
    static void encode(Encoder& e, const daceDS::datamodel::StatusMsg& v) {
    ...
    static void decode(Decoder& d, daceDS::datamodel::StatusMsg& v) {
